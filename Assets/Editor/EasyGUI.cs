...
/// <summary>
/// Put this script on the Editor folder of your Unity project.
/// This tool can be found under Tools/EasyGUI
/// This tool is helpfull to do some manipulations on UI anchors.
/// </summary>

public class EasyGUI : MonoBehaviour
{
    [MenuItem("Tools/EasyGUI/Anchors to Corners %[")]
    static void AnchorsToCorners()
    {
        foreach(RectTransform _rectTransform in Selection.transforms)
        {
            ...
            Vector2 newAnchorsMin = new Vector2(_rectTransform.anchorMin.x + _rectTransform.offsetMin.x / _parent.rect.width,
                                                _rectTransform.anchorMin.y + _rectTransform.offsetMin.y / _parent.rect.height);

            Vector2 newAnchorsMax = new Vector2(_rectTransform.anchorMax.x + _rectTransform.offsetMax.x / _parent.rect.width,
